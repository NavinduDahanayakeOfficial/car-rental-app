...
import toyotaLogo from '../assets/images/toyota.jpg';
import fordLogo from '../assets/images/ford.jpg';
import mercedesLogo from '../assets/images/mercedes.png';
import jeepLogo from '../assets/images/jeep.jpg';
  ...
  return (
    ...
    <div className="container mx-auto p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-12 text-center">
        <div>
          ...
          <p className="mt-2 text-gray-700">Oxford Ave. Cary, NC 27511</p>
        </div>
        <div>
    ...
    <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "How To Choose The Right Car", date: "12 April 2024" },
              { title: "Which plan is right for me?", date: "12 April 2024" },
              { title: "Enjoy Speed, Choice & Total Control", date: "12 April 2024" },
            ].map((post, index) => (
              <div key={index} className="rounded-lg overflow-hidden bg-gray-100 shadow-md">
                <Image
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 text-sm mt-1">News / {post.date}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="mt-16">
          <div className="flex justify-center space-x-8">
            {[toyotaLogo, fordLogo, mercedesLogo, jeepLogo, bmwLogo, audiLogo].map((logo, index) => (
              <Image
                key={index}
                src={logo}
